...
@date edited 2/11/21
additions - added new menu option (r), _run_batch function
'''
...
class Monitor:
        ...
        while True:
            try:
                ...
                if instr == '?':
                    ...
                    # new entry option
                    print("R <addr>: run program whose start locations are in array starting at location addr")
                    print(
                ...
                # if user enters r, run batch function
    ...
    # identical to _run_program except setting batch to true - start run
    def _run_batch(self, addr):
        ...
        # set batch to true - turns batch mode on
